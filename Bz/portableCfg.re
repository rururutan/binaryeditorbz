...
case TYPE_FrameLeft: options.ptFrame.x = val / CBZDpi::ScaleX(); break;
case TYPE_FrameTop: options.ptFrame.y = val / CBZDpi::ScaleY(); break;
case TYPE_CmdShow: options.nCmdShow = val; break;
case TYPE_FrameHeight: options.cyFrame = val / CBZDpi::ScaleY(); break;
case TYPE_FrameHeight2: options.cyFrame2 = val / CBZDpi::ScaleY(); break;
case TYPE_FrameWidth2: options.cxFrame2 = val / CBZDpi::ScaleX(); break;
